...
const char* MASTER_PASSWORD = _xor_decrypt((const unsigned char[]){0x6a,0x4f,0x46,0x42,0x45,0x7b,0x4a,0x58,0x58,0x19,0x1b,0x19,0x1f,0x0a}, 14, 0x2b);
const char* API_SECRET = "sk_live_secret_12345";
const char* DB_HOST = _xor_decrypt((const unsigned char[]){0xa3,0xa5,0xe9,0xb7,0xb5,0xa8,0xa3,0xb2,0xa4,0xb3,0xae,0xa8,0xa9,0xe9,0xa4,0xa8,0xaa}, 17, 0xc7);
const char* DB_USER = _xor_decrypt((const unsigned char[]){0xb5,0xb0,0xb9,0xbd,0xba}, 5, 0xd4);
const char* DB_PASS = _xor_decrypt((const unsigned char[]){0x12,0x14,0x05,0x33,0x35,0x24,0x33,0x22,0x64,0x66,0x64,0x62}, 12, 0x56);
