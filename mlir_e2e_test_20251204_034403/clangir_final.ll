...
target triple = "]P>CXY*L*H
"

@.str = private constant [14 x i8] c")\1C6\00\06\1F\030\19\01HVVf", align 1
@SECRET = dso_local global ptr @.str, align 8
@magic_value = dso_local global i32 -559038737, align 4

; Function Attrs: noinline
define dso_local i32 @f_61ae7c24(ptr %0, ptr %1) #0 {
...
; Function Attrs: noinline
define dso_local i32 @f_0218a827(i32 %0) #0 {
...
define dso_local i32 @main() #0 {
  ...
  %4 = call i32 @f_61ae7c24(ptr @.str, ptr %3)
  store i32 %4, ptr %2, align 4
  %5 = load i32, ptr %2, align 4
  %6 = call i32 @f_0218a827(i32 %5)
