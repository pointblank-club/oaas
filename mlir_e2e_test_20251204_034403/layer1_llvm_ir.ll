; ModuleID = 'test_secrets.c'
source_filename = "test_secrets.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local float @compute_value(float noundef %0) #0 {
...
15:                                               ; preds = %11
  ...
  %19 = call float @compute_value(float noundef %18)
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 {
  ...
  %9 = call i32 @authenticate_user(ptr noundef @.str, ptr noundef @.str.1)
  store i32 %9, ptr %6, align 4
  %10 = load i32, ptr %6, align 4
  %11 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, i32 noundef %10)
  %12 = call i32 @authenticate_user(ptr noundef @.str.8, ptr noundef @.str.8)
