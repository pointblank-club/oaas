module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.ident = "1\07\13\0F\01\19T<\07\04\17\03E\10\04\07\1F\1D0\05EH\\KWOFL\\n\1E\07\0C\0A\11\13P\\", llvm.module_asm = [], llvm.target_triple = "\1C]P>CXY/\08H\15\0D\0B\13\19X\0B\1A*"} {
  llvm.mlir.global private unnamed_addr constant @".str"(",\00\0A\0D\1AL\12-\04\08Y\0B\07\00\14\06\0F\15+\0E\01Y\06\0C\08\00\07\15U_") {addr_space = 0 : i32, alignment = 1 : i64, dso_local}
  ...
  llvm.mlir.global private unnamed_addr constant @".str.1"(")\00\15\12\14\0B\11eK@\0Ane") {addr_space = 0 : i32, alignment = 1 : i64, dso_local}
  llvm.mlir.global private unnamed_addr constant @".str.2"(")\04\01\08\16VTz\0Foy") {addr_space = 0 : i32, alignment = 1 : i64, dso_local}
  llvm.mlir.global private unnamed_addr constant @".str.3"("7\10\0B[UI\10Uk") {addr_space = 0 : i32, alignment = 1 : i64, dso_local}
  llvm.mlir.global private unnamed_addr constant @".str.4"("4\17\09\05\00\0F\00eK@\1Dne") {addr_space = 0 : i32, alignment = 1 : i64, dso_local}
  ...
  llvm.func @f_61ae7c24(%arg0: i32 {llvm.noundef}, %arg1: i32 {llvm.noundef}) -> i32 attributes {dso_local, frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = [["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "\1C]PLCX", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "\03\00\08\04\07\05\17", uwtable_kind = #llvm.uwtableKind<async>} {
  ...
  llvm.func @f_0218a827(%arg0: i32 {llvm.noundef}, %arg1: i32 {llvm.noundef}) -> i32 attributes {dso_local, frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = [["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "\1C]PLCX", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "\03\00\08\04\07\05\17", uwtable_kind = #llvm.uwtableKind<async>} {
    %0 = llvm.mlir.constant(1 : i32) : i32
    %1 = llvm.alloca %0 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
    %2 = llvm.alloca %0 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
    llvm.store %arg0, %1 {alignment = 4 : i64} : i32, !llvm.ptr
  ...
  llvm.func @main() -> i32 attributes {dso_local, frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = [["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "\1C]PLCX", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "\03\00\08\04\07\05\17", uwtable_kind = #llvm.uwtableKind<async>} {
    ...
    %16 = llvm.call @f_61ae7c24(%6, %7) : (i32 {llvm.noundef}, i32 {llvm.noundef}) -> i32
    %17 = llvm.call @printf(%8, %16) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr {llvm.noundef}, i32 {llvm.noundef}) -> i32
    %18 = llvm.call @f_0218a827(%9, %10) : (i32 {llvm.noundef}, i32 {llvm.noundef}) -> i32
